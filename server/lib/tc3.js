...
// and the account must have the Hunyuan service activated. Tencent retires this API on 2026-09-30: it is the
// fallback while TOKENHUB_API_KEY is unset, and goes with that date.
const hunyuan = (creds, action, payload) => call(creds, { service: 'hunyuan', version: '2023-09-01', action, payload, timeoutMs: 120_000 });

module.exports = { call, asr, hunyuan };

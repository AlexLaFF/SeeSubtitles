...
(function () {
  ...
  view.render = async function (root) {
    ...
    su.append(row(t('settings.anthropicKey'), sumKey), hint(t('settings.sumHint')), row(t('settings.model'), sumModel), row(t('settings.sumLang'), sumLang), row(t('settings.effort'), sumEffort));
